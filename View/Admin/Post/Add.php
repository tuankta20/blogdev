...
<form method="post" action="http://localhost/Blog/admin.php?page=addpost" style="padding: 15px">
    <br>
    <h4>Title:</h4>
    ...
    <h4>Category:</h4>
    <input type="text" style="width: 100%;border: 0.1px solid lightgray ;outline: none;height: 50px;padding:0px 15px "
           name="id_category" value="<?php echo $data->id ?>" hidden>
    <input style="width: 100%;border: 0.1px solid lightgray ;outline: none;height: 50px;padding:0px 15px "
    ...
    border: none;color: white " value="Add Post" name="submit">
